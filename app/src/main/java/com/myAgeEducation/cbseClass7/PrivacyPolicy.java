...
public class PrivacyPolicy extends Activity {
    ...
    private void setPrivacyPolicy()
    {
        ...
        String policy = "    <html>\n" +
                "    <body>\n" +
                "    <h2>Privacy Policy</h2> <p> MyAge Education built the CBSE Class 7 app as a Commercial app. This SERVICE is provided by\n" +
                "                    MyAge Education  and is intended for use as is.\n" +
                ...
                "                    accessible at MyAge Education unless otherwise defined in this Privacy Policy.\n" +
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            textViewPrivacyPolicy.setText(Html.fromHtml(policy, Html.FROM_HTML_MODE_LEGACY));
        }
        else
        {
            textViewPrivacyPolicy.setText(Html.fromHtml(policy));
        }
    }
}
